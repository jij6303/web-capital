const COUNTRIES = [
  ...
  { code: "CD", name: "DR Congo", capital: "Kinshasa" },
  { code: "CR", name: "Costa Rica", capital: "San Jose" },
  ...
  { code: "KI", name: "Kiribati", capital: "Tarawa" },
  ...
  { code: "MV", name: "Maldives", capital: "Male" },
  ...
  { code: "PY", name: "Paraguay", capital: "Asuncion" },
  ...
  { code: "ST", name: "Sao Tome and Principe", capital: "Sao Tome" },
  ...
  { code: "TO", name: "Tonga", capital: "Nukualofa" },
  ...
  { code: "YE", name: "Yemen", capital: "Sanaa" },
